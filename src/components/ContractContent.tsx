...
const ContractContent = ({
  apporteurName = "[Apporteur d'affaires — à compléter]",
  donneurOrdre = "Lynx",
  signatureData,
  signedAt,
  showSignature = false,
  ...
  return (
    <div className="space-y-6 text-sm leading-relaxed text-foreground/90">
      ...
      <div className="space-y-2">
        ...
        <p className="font-medium text-foreground">{donneurOrdre}</p>
        <p>Ci-après « le donneur d'ordre »</p>
        <p className="text-center font-medium">D'une part,</p>
        <p className="font-semibold">ET</p>
        <p className="font-medium text-foreground">{apporteurName}</p>
      ...
      <div className="mt-8 pt-4 border-t border-border/50">
        <p className="text-center font-semibold">
          Fait à Paris, le {dateStr} à {timeStr}, en 2 exemplaires.
        </p>
        <div className="grid grid-cols-2 gap-8 mt-6">
          <div className="text-center">
            <p className="font-semibold text-muted-foreground">LE DONNEUR D'ORDRE</p>
            <p className="mt-1 text-sm">{donneurOrdre}</p>
          </div>
          <div className="text-center">
            <p className="font-semibold text-muted-foreground">L'APPORTEUR D'AFFAIRES</p>
            <p className="mt-1 text-sm">{apporteurName}</p>
            {showSignature && signatureData && (
              <div className="mt-3 flex justify-center">
                <img src={signatureData} alt="Signature" className="max-h-20 object-contain" />
              </div>
            )}
          </div>
        </div>
